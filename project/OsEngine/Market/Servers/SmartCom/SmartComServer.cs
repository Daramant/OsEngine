...
namespace OsEngine.Market.Servers.SmartCom
{
    ...
    public class SmartComServer : IServer
    {
        ...
        public ServerConnectStatus ServerStatus => throw new NotImplementedException();

        public DateTime ServerTime => throw new NotImplementedException();

        public DateTime LastStartServerTime => throw new NotImplementedException();

        public List<Portfolio> Portfolios => throw new NotImplementedException();

        public List<Security> Securities => throw new NotImplementedException();

        public List<Trade>[] AllTrades => throw new NotImplementedException();

        public List<MyTrade> MyTrades => throw new NotImplementedException();
        ...
        public CandleSeries GetCandleDataToSecurity(string securityName, string securityClass, TimeFrameBuilder timeFrameBuilder, DateTime startTime, DateTime endTime, DateTime actualTime, bool neadToUpdate)
        {
            throw new NotImplementedException();
        }
